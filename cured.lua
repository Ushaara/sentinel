...
trigs.combat.cured = {
  ...
  { id = "burns_all",
      ...
      notes = "burns cleared" },
  { id = "health_sip",
      line = "^The potion heals and soothes you%.$",
      action = function (i, tbl) cured_(i, tbl) end,
      notes = "preceded by: You take a drink of a potion of healing from an onyx vial." },
  { id = "mana_sip",
      line = "^Your mind feels stronger and more alert%.$",
      action = function (i, tbl) cured_(i, tbl) end,
      notes = "preceded by: You take a drink of a potion of mana from an onyx vial." },
  { id = "shivering",

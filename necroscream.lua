...
trigs.defs.necroscream = {
  ...
  { id = "ironchord",
      line = "^You play a harsh chord on .* and direct the notes towards an old rat%.$",
      action = function (i, tbl) necroscream_(i, tbl) end,
      notes = "50% excoro, 50% cutting" },
  { id = "ironchord_hit",
      line = "^(.*)%'s skin writhes as if worms are crawling beneath the surface%.$",
      action = function (i, tbl) necroscream_(i, tbl) end,
      notes = "target is hearing" },
  { id = "ironchord_kill",
      line = "^(.*)%'s skin cracks as black hissing tendrils burst forth%, instantly killing [hH]%a+%.$",
      action = function (i, tbl) necroscream_(i, tbl) end,
      notes = "kill line" },
}

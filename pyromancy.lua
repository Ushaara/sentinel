...
trigs.combat.pyromancy = {
  ...
  { id = "heatwave",
      ...
      action = function (i, tbl) pyromancy_(i, tbl) end,
      notes = "not sure what this does, derp" },
  { id = "flashfire",
      line = "^Your flesh turns red as a sheet of shimmering fire envelops you%.$",
      action = function (i, tbl) pyromancy_(i, tbl) end,
      notes = "maybe this was the burn level one" },
  { id = "salamanders",
  ...
  { id = "ashfall",
      ...
      action = function (i, tbl) pyromancy_(i, tbl) end,
      notes = "if it looks and talks like asthma, is it asthma?" },
  { id = "flamering",
